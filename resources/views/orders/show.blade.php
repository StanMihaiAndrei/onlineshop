        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 md:p-8">
                <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Comanda {{ $order->order_number }}</h1>
                        <p class="text-gray-600">Plasată la {{ $order->created_at->format('F d, Y \a\t H:i') }}</p>
                    </div>
                ...
                @if($order->coupon_id && $order->discount_amount > 0)
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                <p class="font-semibold text-green-800">Cupon Aplicat: {{ $order->coupon->code }}</p>
                                <p class="text-sm text-green-700">
                                    Ai salvat: RON {{ number_format($order->discount_amount, 2) }}
                    ...
                    <div class="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 mb-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-start">
                                <span class="text-sm text-gray-600 font-medium">Tip Livrare:</span>
                            ...
                            @else
                                ...
                                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                                    <p class="text-xs text-yellow-800">
                                        <span class="font-semibold">💡 Note:</span> Veți primi un SMS/email cu codul de deschidere EasyBox când pachetul dvs. va ajunge.
                                    </p>
                                </div>
                            @endif

                            <div class="flex justify-between items-start">
                                <span class="text-sm text-gray-600 font-medium">Cost Livrare:</span>
                            ...
                            @if($order->sameday_awb_number)
                                <div class="bg-green-50 border-2 border-green-300 rounded-lg p-4 mt-4">
                                    <p class="text-sm font-semibold text-green-900 mb-2">📦 Urmărire Pachet</p>
                            ...
                            @else
                                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mt-4">
                                    <p class="text-xs text-yellow-800">
                                        <span class="font-semibold">⏳ Număr de urmărire în așteptare</span> - Veți primi numărul AWB prin email odată ce pachetul dvs. este preluat de curier.
                                    </p>
                                </div>
                            @endif
                        </div>
                ...
                <div class="border-t border-gray-200 pt-6 mb-6">
                    <h2 class="text-lg font-bold text-gray-900 mb-4">Articole Comandă</h2>
                        ...
                        @foreach($order->items as $item)
                            <div class="flex gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-600">Cantitate: {{ $item->quantity }}</p>
                                    <p class="text-sm text-gray-600">Preț: RON {{ number_format($item->price, 2) }}</p>
                                </div>
                                
                                <div class="text-right">
                                    <p class="font-semibold text-gray-900">RON {{ number_format($item->subtotal, 2) }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="border-t border-gray-200 pt-6 mb-6">
                    ...
                    <div class="flex justify-between pt-2 border-t border-gray-200">
                        ...
                        <span class="text-xl font-bold text-blue-600">RON {{ number_format($order->total_amount, 2) }}</span>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-6 grid md:grid-cols-2 gap-6">
                    <div>
                        <h3 class="font-bold text-gray-900 mb-2">Informații Contact</h3>
                    ...
                    <div>
                        <h3 class="font-bold text-gray-900 mb-2">Metoda de Plată</h3>
                ...
                @if($order->notes)
                    <div class="border-t border-gray-200 pt-6 mt-6">
                        <h3 class="font-bold text-gray-900 mb-2">Note Comandă</h3>
