...
<head>
    ...
    <style>
        ...
        .timeline-item::before {
            ...
            width: 3px;
            height: 100%;
            background: linear-gradient(to bottom, rgb(219, 28, 181), rgb(147, 51, 234));
        }
...
<body class="antialiased font-sans bg-white">
    ...
    <!-- Hero Section -->
    <section class="pt-32 pb-20 hero-about">
    ...
    <section class="py-16 sm:py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="space-y-6">
                    <h2 class="text-3xl sm:text-4xl font-playfair font-bold text-gray-900">
                        De Unde Am Început
                    </h2>
                ...
                <div class="relative">
                    ...
                    <div class="absolute -bottom-6 -right-6 w-32 h-32 bg-pink-200/50 rounded-full blur-3xl"></div>
                    <div class="absolute -top-6 -left-6 w-40 h-40 bg-purple-200/50 rounded-full blur-3xl"></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 gap-6 sm:gap-8">
                <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-lg hover-lift">
                    ...
                    <h3 class="text-2xl font-playfair font-bold text-gray-900 mb-4">Misiunea Noastră</h3>
                ...
                <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-lg hover-lift">
                    ...
                    <h3 class="text-2xl font-playfair font-bold text-gray-900 mb-4">Viziunea Noastră</h3>
                    <p class="text-gray-600 leading-relaxed">
    ...
    <section class="py-16 sm:py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                <div class="text-center p-6 hover-lift bg-gray-50 rounded-xl">
                    <div class="w-16 h-16 bg-pink-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Pasiune</h3>
                ...
                <div class="text-center p-6 hover-lift bg-gray-50 rounded-xl">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Unicitate</h3>
                ...
                <div class="text-center p-6 hover-lift bg-gray-50 rounded-xl">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Calitate</h3>
                ...
                <div class="text-center p-6 hover-lift bg-gray-50 rounded-xl">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Comunitate</h3>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                <div class="bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2 text-center">Inspirație</h3>
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2 text-center">Design</h3>
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2 text-center">Creație</h3>
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2 text-center">Finalizare</h3>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="relative order-2 md:order-1">
                    <img src="{{ asset('images/artisan-work.jpg') }}" 
                         ...
                         class="rounded-2xl shadow-2xl w-full h-[400px] sm:h-[500px] object-cover">
                    <div class="absolute -bottom-6 -left-6 w-32 h-32 bg-pink-200/50 rounded-full blur-3xl"></div>
                </div>
    ...
    <!-- Stats Section -->
    <section class="py-16 sm:py-20 bg-gradient-to-r from-pink-50 to-purple-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                <div class="text-center">
                    <div class="text-4xl sm:text-5xl font-bold text-pink-600 mb-2">1000+</div>
                    <div class="text-gray-600 font-medium">Clienți Mulțumiți</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl sm:text-5xl font-bold text-purple-600 mb-2">500+</div>
                    <div class="text-gray-600 font-medium">Produse Create</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl sm:text-5xl font-bold text-blue-600 mb-2">100%</div>
                    <div class="text-gray-600 font-medium">Handmade</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl sm:text-5xl font-bold text-green-600 mb-2">5★</div>
                    <div class="text-gray-600 font-medium">Rating Mediu</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 sm:py-20 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl sm:text-4xl md:text-5xl font-playfair font-bold text-gray-900 mb-6">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="{{ route('shop') }}" 
                   class="bg-pink-600 text-white px-8 py-3 rounded-full hover:bg-pink-700 transition-all transform hover:scale-105 font-semibold shadow-xl">
                    Descoperă Produsele
                </a>
                <a href="#contact" 
                   class="border-2 border-pink-600 text-pink-600 px-8 py-3 rounded-full hover:bg-pink-600 hover:text-white transition-all font-semibold">
                    Contactează-ne
                </a>
            </div>
        </div>
