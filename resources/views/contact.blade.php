...
<head>
    ...
    <style>
        ...
        .contact-info-card:hover {
            ...
            box-shadow: 0 10px 30px rgba(219, 28, 181, 0.15);
        }
    </style>
</head>
<body class="antialiased font-sans bg-white">
    ...
    <!-- Hero Section -->
    <section class="pt-32 pb-20 hero-contact">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto">
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-playfair font-bold text-gray-900 mb-6 leading-tight">
                    Hai să Vorbim!
                </h1>
    ...
    <section class="py-16 sm:py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16">
                <!-- Email -->
                <div class="contact-info-card bg-gradient-to-br from-pink-50 to-purple-50 p-6 sm:p-8 rounded-2xl border border-pink-100">
                    ...
                    <a href="mailto:{{ env('ADMIN_EMAIL') }}" class="text-pink-600 font-semibold hover:text-pink-700 break-all">
                        {{ env('ADMIN_EMAIL') }}
                    </a>
                </div>

                <!-- Telefon -->
                <div class="contact-info-card bg-gradient-to-br from-purple-50 to-blue-50 p-6 sm:p-8 rounded-2xl border border-purple-100">
                    <div class="w-16 h-16 bg-white rounded-full flex items-center justify-center mb-4 shadow-lg">
                    ...
                    <a href="tel:+40123456789" class="text-purple-600 font-semibold hover:text-purple-700">
                        +40 123 456 789
                    </a>
                </div>

                <!-- Social Media -->
                <div class="contact-info-card bg-gradient-to-br from-blue-50 to-pink-50 p-6 sm:p-8 rounded-2xl border border-blue-100 sm:col-span-2 lg:col-span-1">
                    <div class="w-16 h-16 bg-white rounded-full flex items-center justify-center mb-4 shadow-lg">
                    ...
                    <div class="flex gap-3">
                        <a href="https://www.facebook.com/profile.php?id=100093669974583" class="w-10 h-10 bg-white rounded-full flex items-center justify-center text-pink-600 hover:bg-pink-600 hover:text-white transition-all shadow-md">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                            </svg>
                        </a>
                        <a href="https://www.instagram.com/craftgiftshandmade/" class="w-10 h-10 bg-white rounded-full flex items-center justify-center text-pink-600 hover:bg-pink-600 hover:text-white transition-all shadow-md">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <form action="{{ route('contact.send') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('name') }}"
                                   required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all @error('name') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <input type="email" 
                                   ...
                                   value="{{ old('email') }}"
                                   required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all @error('email') border-red-500 @enderror"
                    ...
                    <div class="grid sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="tel" 
                                   ...
                                   name="phone" 
                                   value="{{ old('phone') }}"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all @error('phone') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <select id="subject" 
                                    name="subject" 
                                    required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all @error('subject') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <textarea id="message" 
                                  ...
                                  rows="6" 
                                  required
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all resize-none @error('message') border-red-500 @enderror"
                    ...
                    <div class="flex justify-center">
                        <button type="submit" 
                                class="px-8 py-4 bg-gradient-to-r from-pink-600 to-purple-600 text-white font-semibold rounded-full hover:shadow-xl hover:scale-105 transition-all duration-200 flex items-center gap-2">
    ...
    <section class="py-16 sm:py-20 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                <details class="group bg-gray-50 rounded-xl p-6 cursor-pointer hover:bg-gray-100 transition-all">
                    <summary class="flex justify-between items-center font-semibold text-gray-900">
                        <span>Cât durează procesarea unei comenzi?</span>
                        <svg class="w-5 h-5 text-pink-600 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
