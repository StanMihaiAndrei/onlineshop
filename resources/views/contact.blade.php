            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16">
                ...
                <div class="contact-info-card bg-gradient-to-br from-blue-50 to-pink-50 p-6 sm:p-8 rounded-2xl border border-blue-100 sm:col-span-2 lg:col-span-1">
                    ...
                    <div class="flex gap-3">
                        <a href="#" class="w-10 h-10 bg-white rounded-full flex items-center justify-center text-pink-600 hover:bg-pink-600 hover:text-white transition-all shadow-md">
